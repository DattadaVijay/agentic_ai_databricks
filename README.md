# agentic_ai_databricks

The 'agentic_ai_databricks' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] agentic_ai_databricks_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/agentic_ai_databricks.job.yml). The schedule
